    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-12 relative z-10">
        ...
        >
          ...
          <div className="blog-content max-w-none text-slate-900 leading-relaxed text-lg">
            <Markdown 
              components={{
                h2: ({node, ...props}) => <h2 className="text-3xl font-bold text-black mt-12 mb-6" {...props} />,
                h3: ({node, ...props}) => <h3 className="text-2xl font-bold text-black mt-8 mb-4" {...props} />,
                p: ({node, ...props}) => <p className="mb-6 leading-relaxed text-black" {...props} />,
                ul: ({node, ...props}) => <ul className="list-disc list-outside space-y-3 mb-8 pl-6 text-black" {...props} />,
                ol: ({node, ...props}) => <ol className="list-decimal list-outside space-y-3 mb-8 pl-6 text-black" {...props} />,
                li: ({node, ...props}) => <li className="pl-2" {...props} />,
                strong: ({node, ...props}) => <strong className="font-bold text-black" {...props} />,
                blockquote: ({node, ...props}) => (
                  <blockquote className="border-l-4 border-slate-200 pl-6 py-2 italic text-slate-600 my-8" {...props} />
                ),
                img: ({node, ...props}) => (
                  <div className="my-10">
                    <img className="w-full h-auto rounded-xl shadow-sm" referrerPolicy="no-referrer" {...props} />
                ...
                code: ({node, ...props}) => <code className="font-mono text-sm bg-slate-50 px-1 rounded" {...props} />,
                pre: ({node, ...props}) => <div className="my-6 whitespace-pre-wrap font-sans text-black">{props.children}</div>,
              }}
            >
              {post.content}
            </Markdown>
